...
/// macOS 플랫폼 권한 처리 구현체
class MacOSPermission implements PermissionPlatform {
  @override
  ...
  List<PermissionType> get supportedPermissions => [
        ...
        // macOS 특화 권한
        PermissionType.macosPhotos,
        PermissionType.macosCalendar,
        PermissionType.macosReminders,
        PermissionType.macosContacts,
        PermissionType.macosMediaLibrary,
        PermissionType.macosSpeech,
      ];
  ...
  Future<bool> shouldShowRequestRationale(PermissionType type) async {
    // macOS에서는 rationale이 항상 false를 반환합니다.
    return false;
  }
  ...
  dynamic convertToPlatformPermission(PermissionType type) {
    switch (type) {
      ...
      // macOS 특화 권한 (iOS와 동일한 권한 사용)
      case PermissionType.macosPhotos:
        return g_lib.Permission.photos;
      case PermissionType.macosCalendar:
        return g_lib.Permission.calendarWriteOnly;
      case PermissionType.macosReminders:
        return g_lib.Permission.reminders;
      case PermissionType.macosContacts:
        return g_lib.Permission.contacts;
      case PermissionType.macosMediaLibrary:
        return g_lib.Permission.mediaLibrary;
      case PermissionType.macosSpeech:
